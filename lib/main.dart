...
class ImageSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      height: 240,
      child: Row(
        mainAxisAlignment: MainAxisAlignment.center, // توسيط الصور
        children: [
          Image.asset(
            image,
            width: 200,
          ...
          SizedBox(width: 20), // المسافة بين الصورة الأولى والثانية
          Image.asset(
            image,
            width: 200,
            height: 240,
          ...
          SizedBox(width: 20), // المسافة بين الصورة الثانية والثالثة
          Image.asset(
            image,
            width: 200,
            height: 240,
